...
const Calltoaction = () => {
  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 bg-[#06091B] text-white w-full overflow-hidden'>
