        ...
        <>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12'>
            {posts.map((post) => (
              <div
                key={post.id}
                className='bg-white overflow-hidden transition-transform hover:transform hover:scale-105'>
                ...
                <div className='p-4'>
                  ...
                  {post.acf && post.acf.type && post.acf.type.rendered && (
                    <div
                      className='text-gray-600 text-sm mb-2'
                      dangerouslySetInnerHTML={renderHTML(
                        post.acf.type.rendered
                      )}
                    />
                  )}
